...
This creates an Ubuntu 26.04 (Resolute) VM named `qemu-minimal` with default
settings. To run the VM:
...
| `RELEASE` | `resolute` | Ubuntu release codename or version (`26.04`, `resolute`, etc.) |
